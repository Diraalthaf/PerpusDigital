                    ...
                    <div class="row">
                        ...
                        ?>
                            <form action="" method="post">
                                <button type="submit" name="all" class="btn <?php echo $selectedCategory === 'all' ? 'btn-danger' : 'btn-outline-danger'; ?>">Semua</button>
                                <button type="submit" name="novel" class="btn <?php echo $selectedCategory === 'novel' ? 'btn-danger' : 'btn-outline-danger'; ?>">Novel</button>
                                <button type="submit" name="komik" class="btn <?php echo $selectedCategory === 'komik' ? 'btn-danger' : 'btn-outline-danger'; ?>">Komik</button>
                                <button type="submit" name="ensiklopedia" class="btn <?php echo $selectedCategory === 'ensiklopedia' ? 'btn-danger' : 'btn-outline-danger'; ?>">Ensiklopedia</button>
                                <button type="submit" name="fiksiilmiah" class="btn <?php echo $selectedCategory === 'fiksiilmiah' ? 'btn-danger' : 'btn-outline-danger'; ?>">Fiksi Ilmiah</button>
                                <button type="submit" name="ilmusosial" class="btn <?php echo $selectedCategory === 'ilmusosial' ? 'btn-danger' : 'btn-outline-danger'; ?>">Ilmu Sosial</button>
                            </form>
